import { Eraser, PenSquare, Palette } from "lucide-react";
...
export const slashCommands: SlashCommand[] = [
  { name: "new", description: "Start a new thread", icon: <PenSquare className="size-3.5" />, action: "new" },
  { name: "clear", description: "Clear this conversation", icon: <Eraser className="size-3.5" />, action: "clear" },
  { name: "theme", description: "Toggle dark / light mode", icon: <Palette className="size-3.5" />, action: "theme" },
];
