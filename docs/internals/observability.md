...
| `orchestrator_abandoned_carts_detected` | (none; value = carts detected) | [`jobs/abandoned-cart.ts`](../../src/jobs/abandoned-cart.ts) | Carts flagged by the abandoned-cart cron. See [commerce.md](commerce.md). |
