...
All routes return JSON. Rate limited at 100 req/60s per tenant. The commerce management surfaces (`/brands`, `/b2b`, `/entities`, `/geo`, consent/attribution) are covered in [internals/commerce.md](../internals/commerce.md).
