...
import * as modelModule from '@felix/harness/patterns/model';
import { buildReactAgent } from '@felix/harness/patterns/react';
import { buildRouterAgent } from '@felix/harness/patterns/router';
import type { ChatMessage } from '@felix/harness/patterns/types';
import { QueueExecutor, queueTool } from '@felix/harness/tools/queue-executor';
